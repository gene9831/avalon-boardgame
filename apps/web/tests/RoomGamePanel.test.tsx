...
describe('RoomGamePanel responsive business shell', () => {
  it('renders one stable set of game controls around a measured stage', () => {
    ...
    expect(html).toContain('>房间 room-12</h1>')
    expect(html).not.toContain('room-game-status-phase')
    expect(html).not.toContain('aria-label="打开用户中心"')
...
describe('RoomGamePanel quest hand', () => {
  ...
  it('gives an Evil quest member both quest card actions', () => {
    ...
    expect(html.match(/data-player-avatar=/g)).toHaveLength(5)
