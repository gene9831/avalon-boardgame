...
export function RoomPhasePanel({ middle, action }: RoomPhasePanelProps) {
  return (
    <div className="grid size-full min-h-0 grid-rows-[minmax(0,1fr)_3.5rem]">
      <div className="grid min-h-0 items-center overflow-hidden px-4 py-2" data-room-slot="phase-middle">{middle}</div>
